...
void toggle03(int Led )
{
 ...
 void toggle010(int Led)
 { 
 	ledOn10 =! ledOn10;
 	digitalWrite(Led, ledOn10);
 }
 void toggle011(int Led)
 { 
 	ledOn11 =! ledOn11;
 	digitalWrite(Led, ledOn11);
 }
 void toggle012(int Led)
 { 
 	ledOn12 =! ledOn12;
...
{//variables locales
	...
	if(teclado=='z'){toggle010(led10);}
	if(teclado=='x'){toggle011(led11);}
	if(teclado=='c'){toggle012(led12);}
}